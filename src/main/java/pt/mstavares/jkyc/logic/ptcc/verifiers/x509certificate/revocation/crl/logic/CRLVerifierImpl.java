...
import pt.mstavares.jkyc.logic.ptcc.verifiers.x509certificate.revocation.gateway.messages.RevocationMessages;
        ...
        try {
            ...
            for (String crlDistPoint : crlDistPoints) {
                ...
                if(crl.isRevoked(certificateToVerify))
                    throw new CertificateRevokedException(RevocationMessages.CRT_REVOKED_ERROR.toString());
            }
